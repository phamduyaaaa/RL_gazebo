...
class DuelingQNetwork(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 32, kernel_size=5, stride=2)  # kernel size and stride adjusted
        self.bn1 = nn.BatchNorm2d(32)

        self.conv2 = nn.Conv2d(32, 64, kernel_size=3, stride=2)  # kernel size and stride adjusted
